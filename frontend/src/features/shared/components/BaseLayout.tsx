...
export const BaseLayout: React.FC<BaseLayoutProps> = ({ children, isLoading, title }) => {
  return (
    <div className="min-h-screen relative overflow-hidden bg-slate-50 dark:bg-[#0a0a0c] selection:bg-primary-500/30">
      {/* Background Effects */}
      ...
      <div className="min-h-screen flex flex-col pl-20 sm:pl-72">
        <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative z-0">
          {title && (
            <div className="mb-8 md:mb-12 animate-in fade-in slide-in-from-left-8 duration-700">
              <h2 className="text-4xl md:text-5xl font-black italic uppercase tracking-tighter text-slate-900 dark:text-white leading-[0.9]">
